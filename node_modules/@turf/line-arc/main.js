...
function lineArc(center, radius, bearing1, bearing2, options) {
    ...
    if (angle1 === angle2) {
        return helpers.lineString(circle(center, radius, options).geometry.coordinates[0], properties);
    }
    ...
    return helpers.lineString(coordinates, properties);
}
