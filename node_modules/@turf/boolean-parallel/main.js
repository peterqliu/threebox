...
function isParallel(segment1, segment2) {
    var slope1 = helpers.bearingToAzimuth(rhumbBearing(segment1[0], segment1[1]));
    var slope2 = helpers.bearingToAzimuth(rhumbBearing(segment2[0], segment2[1]));
...
module.exports = booleanParallel;
