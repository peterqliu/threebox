...
var lineclip = _interopDefault(require('lineclip'));
...
function bboxClip(feature, bbox) {
    ...
    var coords = invariant.getCoords(feature);
    ...
    case 'MultiLineString':
        ...
        if (lines.length === 1) return helpers.lineString(lines[0], properties);
        return helpers.multiLineString(lines, properties);
    case 'Polygon':
        return helpers.polygon(clipPolygon(coords, bbox), properties);
    case 'MultiPolygon':
        return helpers.multiPolygon(coords.map(function (polygon$$1) {
