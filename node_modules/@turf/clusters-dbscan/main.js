...
var clustering = _interopDefault(require('density-clustering'));
...
function clustersDbscan(points, maxDistance, options) {
    ...
    var clusteredIds = dbscan.run(meta.coordAll(points), helpers.convertLength(maxDistance, units), minPoints, distance);
